...
class TestOpenRouterClient:
    ...
    def test_init_sets_api_key_and_base_url(self):
        """Test that OpenRouterClient initializes with API key."""
    ...
    def test_init_with_custom_base_url(self):
        """Test that OpenRouterClient accepts custom base URL."""
    ...
    def test_complete_with_pdf_uses_custom_timeout(self):
        """Test that complete_with_pdf() passes custom timeout to client."""
        client = OpenRouterClient(api_key="test-key")
        pdf_bytes = b"test pdf"
